...
+ RStudio renders a web page on your screen. Thus, it looks and works the same across platforms (Windows, MacOS, and Linux) and you can access a remote RStudio server through your web browser.
...
## Browsing Data in R
Browsing data is difficult in R and can be disorientating for those coming from Excel. Here are several ways to view data:
...
+ Unit Conversion Functions: ac2ha(), c2f(), cubft2cubm(), cubft2gal(), cubm2cubft(), deg2rad(), f2c(), ft2m(), g2lb(), gal2cubft(), ha2ac(), in2mm(), kg2lb(), km2mi(), lb2g(), lb2kg(), m2ft(), mi2km(), mm2in(), and rad2deg().
...
Help information for package functions contains all the information that you need to use the function.
...
1. dfCols(); shows a summary of data.frame columns. This mimics how tibbles print in RStudio. The width of the last column is user specified: defaults to 40, but set to 30 in this case.
